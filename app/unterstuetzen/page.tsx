        ...
        <div className="donate-grid">
          ...
          <div className="donate-card">
            ...
            <div className="donate-amounts">
              {PRESETS.map((v) => {
                ...
                return (
                  <button
                    key={v}
                    className={['amount', active ? 'is-active' : ''].join(' ').trim()}
                    onClick={() => {
                      setAmount(v)
                      setCustom('')
                    }}
              ...
              <div className="amount amount--custom" title="Eigener Betrag">
                <label className="amount-label" htmlFor="amount-custom-input">
                  Eigener Betrag
                </label>
                <input
            ...
            >
              {loading
                ? 'Lädt…'
                : interval === 'month'
                ? `Monatlich unterstützen (${display}€)`
                : `Einmalig unterstützen (${display}€)`
              }
            </button>
            ...
            <div className="trust-row">
              ...
              <img src="/icons/payments/payment-icons/sepa.svg" alt="SEPA Lastschrift" loading="lazy" />
              <img src="/icons/payments/payment-icons/klara.svg" alt="Klarna" loading="lazy" />
          ...
          <div className="card fade-slide">
            <div className="card-body">
              ...
              <ul className="list">
                <li>
                  <strong>Betrieb & Infrastruktur</strong> (Hosting, Monitoring, Sicherheit)
                </li>
                <li>
                  <strong>Weiterentwicklung</strong> (ruhige Tools, Barrierefreiheit, Mehrsprachigkeit)
                </li>
                <li>
                  <strong>Inhalte & Aufklärung</strong> (Texte, Audio, Kooperationen)
                </li>
              </ul>
            </div>
          </div>
